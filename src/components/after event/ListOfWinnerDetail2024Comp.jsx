    ...
    return(
        ...
        <section className="low-detail-after-event-section" id="low-detail-after-event">
            <div className="low-detail-after-event-heading">
                <h1 className="section-header">After Event IYCO 2024</h1>
            </div>
            ...
            <div className="low-detail-document-container">
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <a href="https://drive.google.com/file/d/1QrdM0O97yCa20Z4EwYaK-i_3nbSo7Kzo/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div>
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        <h2>Curation</h2>
                        <br />
                        <a href="https://drive.google.com/drive/folders/1dNw4Hu1TAkXnqcyPoVeOAI4RtHUyBazM?usp=sharing" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div>
